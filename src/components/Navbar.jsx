...
const Search = () => {
	...
	return (
		<div className="relative">
			...
			{showSuggestions && (
				<div className="absolute mt-2 p-2 bg-white max-h-80 overflow-y-scroll rounded-md shadow-md w-full z-20 top-full text-gray-800">
					{searchResults.results && searchResults.results.length > 0 ? (
						...
						<p className="px-4 h-20 grid place-items-center">No results found</p>
					)}
				</div>
			)}
		</div>
