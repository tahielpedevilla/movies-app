			...
			<div className="relative group">
				<button onClick={() => handleAddFavorite(movie)} className="absolute top-2 right-2 z-10">
					<svg
						...
						strokeWidth="1.5"
						stroke="currentColor"
						className="w-8 h-8 hover:fill-yellow-500 stroke-yellow-500"
					>
						<path
							strokeLinecap="round"
				...
				<img
					...
					loading="lazy"
				/>
				<div className="absolute inset-0 bg-gradient-to-bl from-black to-transparent opacity-50 transition duration-300 ease-in-out group-hover:opacity-60" />
			</div>
